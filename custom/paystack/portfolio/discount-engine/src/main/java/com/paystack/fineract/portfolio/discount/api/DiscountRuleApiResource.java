...
/**
 * Discount Rule API Resource
 * REST API endpoints for discount rule management
 */
...
public class DiscountRuleApiResource {
    ...
    public DiscountRuleData retrieveDiscountRule(
    ...
    public CommandProcessingResult createDiscountRule(
        ...
        final CommandWrapper commandRequest = new CommandWrapperBuilder()
                .createDiscountRule()
                .withJson(toApiJsonSerializer.serialize(ruleData))
                .build();
    ...
    public DiscountRuleTypeInfo getRuleTypeInfo(
            @PathParam("ruleType") @Parameter(description = "ruleType") final String ruleType) {
