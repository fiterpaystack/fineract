...
/**
 * Value-Based Discount Calculator
 * Applies discounts based on transaction volume (inflows/outflows) within periods
 */
...
public class SavingsAccountTransactionFlowDiscountCalculator implements DiscountRuleCalculator {
    ...
    public BigDecimal calculateDiscount(BigDecimal originalAmount, DiscountContext context) {
        ...
        try {
            ...
            log.error("VALUE CALCULATOR: Error calculating value-based discount for account {}: {}", 
    ...
    public boolean isValid(DiscountContext context) {
        return thresholdAmount != null && 
               ...
               directionType != null && 
               !directionType.trim().isEmpty() &&
               periodType != null && 
               !periodType.trim().isEmpty() &&
