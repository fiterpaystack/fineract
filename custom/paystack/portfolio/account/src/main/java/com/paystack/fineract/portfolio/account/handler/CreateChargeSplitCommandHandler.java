...
@Service
@CommandType(entity = "CHARGE_SPLIT", action = "CREATE")
@RequiredArgsConstructor
public class CreateChargeSplitCommandHandler implements NewCommandSourceHandler {
    ...
    public CommandProcessingResult processCommand(final JsonCommand command) {
        return this.splitService.createSplit(command);
    }
}
