...
public class PaystackApplyAnnualFeeForSavingsTasklet implements Tasklet {
    ...
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
        ...
        for (final SavingsAccountAnnualFeeData savingsAccountReference : annualFeeData) {
            try {
                ...
                exceptions.add(ex);
                log.error("Apply annual fee for savings failed for account: {}",
                        savingsAccountReference.getAccountNo() + " : " + ex.getLocalizedMessage());
            }
        }
