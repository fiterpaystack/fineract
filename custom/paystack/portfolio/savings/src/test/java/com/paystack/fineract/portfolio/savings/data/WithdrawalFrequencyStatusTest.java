...
class WithdrawalFrequencyStatusTest {
    ...
    void testConstructor_WithPeriodStatuses() {
        WithdrawalFrequencyStatus.PeriodStatus periodStatus1 = new WithdrawalFrequencyStatus.PeriodStatus(TimePeriod.DAILY, 2, 5, 3, true);
        WithdrawalFrequencyStatus.PeriodStatus periodStatus2 = new WithdrawalFrequencyStatus.PeriodStatus(TimePeriod.WEEKLY, 1, 3, 2, true);
    ...
    void testGetMostRestrictivePeriod_SinglePeriod() {
        WithdrawalFrequencyStatus.PeriodStatus periodStatus = new WithdrawalFrequencyStatus.PeriodStatus(TimePeriod.MONTHLY, 5, 4, 1,
                false);
    ...
    void testGetMostRestrictivePeriod_MultiplePeriods() {
        WithdrawalFrequencyStatus.PeriodStatus dailyStatus = new WithdrawalFrequencyStatus.PeriodStatus(TimePeriod.DAILY, 2, 1, 1, false);
        WithdrawalFrequencyStatus.PeriodStatus weeklyStatus = new WithdrawalFrequencyStatus.PeriodStatus(TimePeriod.WEEKLY, 5, 2, 3, false);
        WithdrawalFrequencyStatus.PeriodStatus monthlyStatus = new WithdrawalFrequencyStatus.PeriodStatus(TimePeriod.MONTHLY, 20, 10, 10,
                false);

        WithdrawalFrequencyStatus status = new WithdrawalFrequencyStatus(false, Arrays.asList(dailyStatus, weeklyStatus, monthlyStatus));
    ...
    void testPeriodStatus_Constructor() {
        WithdrawalFrequencyStatus.PeriodStatus periodStatus = new WithdrawalFrequencyStatus.PeriodStatus(TimePeriod.WEEKLY, 5, 3, 2, false);
    ...
    void testPeriodStatus_IsLimitExceeded() {
        WithdrawalFrequencyStatus.PeriodStatus periodStatus = new WithdrawalFrequencyStatus.PeriodStatus(TimePeriod.MONTHLY, 5, 5, 0,
                false);
    ...
    void testPeriodStatus_IsNotLimitExceeded() {
        WithdrawalFrequencyStatus.PeriodStatus periodStatus = new WithdrawalFrequencyStatus.PeriodStatus(TimePeriod.MONTHLY, 3, 5, 2, true);
    ...
    void testPeriodStatus_GetUsagePercentage() {
        WithdrawalFrequencyStatus.PeriodStatus periodStatus = new WithdrawalFrequencyStatus.PeriodStatus(TimePeriod.MONTHLY, 5, 3, 2, true);
    ...
    void testPeriodStatus_GetUsagePercentage_ZeroMax() {
        WithdrawalFrequencyStatus.PeriodStatus periodStatus = new WithdrawalFrequencyStatus.PeriodStatus(TimePeriod.MONTHLY, 3, 0, 0,
                false);
    ...
    void testPeriodStatus_ToString() {
        WithdrawalFrequencyStatus.PeriodStatus periodStatus = new WithdrawalFrequencyStatus.PeriodStatus(TimePeriod.DAILY, 5, 2, 3, true);
    ...
    void testPeriodStatus_Equals() {
        WithdrawalFrequencyStatus.PeriodStatus status1 = new WithdrawalFrequencyStatus.PeriodStatus(TimePeriod.DAILY, 2, 5, 3, true);
        WithdrawalFrequencyStatus.PeriodStatus status2 = new WithdrawalFrequencyStatus.PeriodStatus(TimePeriod.DAILY, 2, 5, 3, true);
    ...
    void testPeriodStatus_NotEquals() {
        WithdrawalFrequencyStatus.PeriodStatus status1 = new WithdrawalFrequencyStatus.PeriodStatus(TimePeriod.DAILY, 2, 5, 3, true);
        WithdrawalFrequencyStatus.PeriodStatus status2 = new WithdrawalFrequencyStatus.PeriodStatus(TimePeriod.WEEKLY, 2, 5, 3, true);
    ...
    @Test
    void testToString() {
        WithdrawalFrequencyStatus.PeriodStatus periodStatus = new WithdrawalFrequencyStatus.PeriodStatus(TimePeriod.MONTHLY, 4, 5, 1, true);
    ...
    void testGettersAndSetters() {
        ...
        status.setPeriodStatuses(Arrays.asList(new WithdrawalFrequencyStatus.PeriodStatus(TimePeriod.DAILY, 1, 2, 1, true)));
