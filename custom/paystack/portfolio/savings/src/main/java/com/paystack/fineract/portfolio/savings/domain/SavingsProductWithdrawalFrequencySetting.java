...
/**
 * Savings Product Withdrawal Frequency Setting Entity Represents withdrawal frequency limits configured at the product
 * level Each product can have multiple settings for different time periods (daily, weekly, monthly, yearly)
 */
@Entity
@Table(name = "m_savings_product_withdrawal_frequency_setting", uniqueConstraints = @UniqueConstraint(columnNames = { "savings_product_id",
        "time_period" }, name = "uq_spwfs_product_period"))
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
public class SavingsProductWithdrawalFrequencySetting extends AbstractAuditableWithUTCDateTimeCustom<Long> {
    ...
    public String toString() {
        return "SavingsProductWithdrawalFrequencySetting{" + "id=" + getId() + ", savingsProductId=" + savingsProductId
